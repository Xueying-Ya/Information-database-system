    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
                    <h1 style="margin-top: 10px">Survey_info Table</h1>
                    <?php
                        ...
                        <table class="table table-striped table-sm" id="myTable">
                            ...
                            <tbody>
                                <?php if($stmt->rowCount() > 0){
                                 ...
                                 ?>
                                 <tr>
                                    <td><?php print($rowUser['surveyID']); ?></td>
									
									<td><?php print($rowUser['activityID']); ?></td>
									
                                    <td><?php print($rowUser['year']); ?></td>
									
									<td>
                                      <a href="form.php?edit_id=<?php print($rowUser['surveyID']); ?>">
                                      <?php print($rowUser['status']); ?>
                                      </a>
                                    </td>
							
                                    <td>
                                      <a class="confirmation" href="index.php?delete_id=<?php print($rowUser['surveyID']); ?>">
        ...
        <script>
            ...
            $('.confirmation').on('click', function () {
                return confirm('คุณจะลบแบบประเมินนี้จริงๆเหรอ?');
            });
        </script>
	        <script>
